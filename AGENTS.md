...
This project is indexed by GitNexus as **Lumora.FE.Admin** (3847 symbols, 5163 relationships, 140 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
