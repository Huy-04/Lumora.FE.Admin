# FE-AUDIT-014 Deep Shipment Contract and Business-Logic Review
...
Perform a source-based deep review of the FE Admin `Shipment` module against the
current Lumora.BE shipment behavior, covering both API contract alignment and
...
- Review FE Shipment flows against live BE semantics for list/search/detail,
  draft/submission/status progression, shipment-order linkage, and retry-like
...
- Audit target: FE Admin Shipment module.
- Behavior source: Lumora.BE Shipment module controllers/handlers/services plus
  shipment-related order flow semantics.
...
| Integration | Shipment FE behavior assessed against live BE semantics |
...
- Live FE source reads for Shipment flows and components.
- Live BE source reads for Shipment rule enforcement and response behavior.
