# FE-AUDIT-006 Deep Product Contract and Business-Logic Review
...
Perform a source-based deep review of the FE Admin `Product` module against the
current Lumora.BE product behavior, covering both API contract alignment and
...
- Review FE Product flows against live BE semantics for list/search/detail,
  create/update, assets/gallery/variants/attributes, status changes, and
  reorder-like actions where applicable.
...
- Behavior source: Lumora.BE Product controllers/handlers/services.
...
- Live FE source reads for Product flows and components.
- Live BE source reads for Product rule enforcement and response behavior.
